// Panchakarma Questions Data
const questions = [
    {
        question: "Sample question 1 for Panchakarma",
        options: ["A. Option 1", "B. Option 2", "C. Correct Answer", "D. Option 4"],
        correct: 2
    },
    {
        question: "Sample question 2 for Panchakarma",
        options: ["A. Option 1", "B. Correct Answer", "C. Option 3", "D. Option 4"],
        correct: 1
    },
    {
        question: "Sample question 3 for Panchakarma",
        options: ["A. Correct Answer", "B. Option 2", "C. Option 3", "D. Option 4"],
        correct: 0
    },
    {
        question: "Sample question 4 for Panchakarma",
        options: ["A. Option 1", "B. Option 2", "C. Option 3", "D. Correct Answer"],
        correct: 3
    },
    {
        question: "Sample question 5 for Panchakarma",
        options: ["A. Option 1", "B. Correct Answer", "C. Option 3", "D. Option 4"],
        correct: 1
    }
];
